#include "DialogAddMuseum.h"
#include "ui_DialogAddMuseum.h"
#include <QDebug>

DialogAddMuseum::DialogAddMuseum(int row, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DialogAddMuseum)
{
    ui->setupUi(this);
...
DialogAddMuseum::~DialogAddMuseum()
{
    delete ui;
}
 ...
 * */
void DialogAddMuseum::setupModel()
{
    ...
    mapper->addMapping(ui->InformationTextEdit, 4);
 ...
 * */
void DialogAddMuseum::createUI()
{

}

void DialogAddMuseum::on_buttonBox_accepted()
{
 ...
 * */
void DialogAddMuseum::updateButtons(int row)
{
